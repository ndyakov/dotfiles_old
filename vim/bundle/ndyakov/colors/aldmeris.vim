...
" -------------------------------------------
call s:Hi( 'ColorColumn',   s:black,        "NONE" )
" Conceal		placeholder characters substituted for concealed
call s:Hi( 'Cursor',        s:aluminium1,   s:black )
" CursorIM	like Cursor, but used when in IME mode
call s:Hi( 'CursorColumn',  s:aluminium1,   "NONE",         "NONE" )
call s:Hi( 'CursorLine',    s:black,   "NONE",         "NONE" )
